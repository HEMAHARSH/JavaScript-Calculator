...
class Button extends React.Component {
  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        "button",
        { id: "clear", onClick: this.props.reset, value: "AC" },
        "AC"
      ),
      ...
      React.createElement(
        "button",
        { id: "zero", onClick: this.props.numbers, value: "0" },
        "0"
      ),
      ...
      React.createElement(
        "button",
        { id: "equals", onClick: this.props.evaluate, value: "=" },
        "="
      )
    );
  }
...
class Output extends React.Component {
  ...
  render() {
    return React.createElement(
      "div",
      { className: "output display", id: "display" },
      this.props.output
    );
  }
}
